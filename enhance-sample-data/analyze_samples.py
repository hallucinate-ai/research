...
print("dst_aesthetic_score vs cfg_scale")
print(np.corrcoef(dst_aesthetic_score, cfg_scale))
print("dst_aesthetic_score vs ddim_steps")
print(np.corrcoef(dst_aesthetic_score, ddim_steps))
print("dst_aesthetic_score vs denoising_strength")
print(np.corrcoef(dst_aesthetic_score, denoising_strength))
plt.show()
...
regr.fit(np.column_stack((cfg_scale_train, ddim_steps_train, denoising_strength_train)), dst_aesthetic_score_train)

# Make predictions using the testing set
dst_aesthetic_score_pred = regr.predict(np.column_stack((cfg_scale_test, ddim_steps_test, denoising_strength_test)))
...
% mean_squared_error(dst_aesthetic_score_test, dst_aesthetic_score_pred))
# Explained variance score: 1 is perfect prediction
print('Variance score: %.2f' % r2_score(dst_aesthetic_score_test, dst_aesthetic_score_pred))
...
#ax.scatter(cfg_scale_test, ddim_steps_test, denoising_strength_test, c=dst_aesthetic_score_pred)
...
m.set_array(dst_aesthetic_score_test)
#label the colorbar
plt.colorbar(m, label='dst_aesthetic_score')
...
stats = {}
stats["name"] = "dst_aesthetic_score"
stats["correlations"] = {}
stats["correlations"]["cfg_scale"] = str(np.corrcoef(dst_aesthetic_score, cfg_scale)[0][1])
stats["correlations"]["ddim_steps"] = str(np.corrcoef(dst_aesthetic_score, ddim_steps)[0][1])
stats["correlations"]["diff_similarity"] = str(np.corrcoef(dst_aesthetic_score, denoising_strength)[0][1])
stats["coefficients"] = str(regr.coef_)
stats["mean_squared_error"] = str(mean_squared_error(dst_aesthetic_score_test, dst_aesthetic_score_pred))
stats["variance_score"] = str(r2_score(dst_aesthetic_score_test, dst_aesthetic_score_pred))
