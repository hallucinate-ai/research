...
os.environ['STABILITY_KEY'] = 'sk-wv8eYQfSKSDDrDDrALOQJXUQq04yencKQ3sS0wxsufnyansC'
...
answers = stability_api.generate(
    prompt="A teddy bear riding a motorcycle",
    seed=1000, # If a seed is provided, the resulting generated image will be deterministic.
